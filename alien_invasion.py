...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.info = Info(self, "Info Screen")
        ...
        self.quit_button = Quit(self, "Quit")

        # Make the Info button.
        self.info_button = Info(self, "Press 'P' to pause and "
                                      "'Q' to quit.")

        # Make the Resume button.
        self.resume_button = Resume(self, "Press 'R' to resume the game.")
    ...
    def pause(self):
        ...
        paused = True
        while paused:
            self.resume_button.draw_resume_button()
            pygame.display.flip()
    ...
    def _fire_bullet(self):
        ...
        if self.stats.game_active:
            if len(self.bullets) < self.settings.bullets_allowed:
                ...
                shot = pygame.mixer.Sound('files/bullet.wav')
    ...
    def _update_screen(self):
        ...
        if not self.stats.game_active:
            ...
            self.info_button.draw_info_button()
